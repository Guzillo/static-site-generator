...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_delim_bold_and_italic(self):
        ...
        new_nodes1 = split_nodes_delimiter([node], "**", TextType.BOLD)
        new_nodes = split_nodes_delimiter(new_nodes1, "_", TextType.ITALIC)
        self.assertListEqual(
            [
    ...
    def test_split_images_no_occurences(self):
        node = TextNode(
            "This is text with an [image](https://i.imgur.com/zjjcJKZ.png) and another [second image](https://i.imgur.com/3elNhQu.png)",
            TextType.PLAIN,
        )
    ...
    def test_split_images_1_occurence_1_not(self):
        node = TextNode(
            "This is text with an [image](https://i.imgur.com/zjjcJKZ.png) and another ![second image](https://i.imgur.com/3elNhQu.png)",
            TextType.PLAIN,
        )
    ...
    def test_to_textnodes_all(self):
